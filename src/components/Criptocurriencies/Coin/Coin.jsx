    ...
    <>
      {coin?.statusText === undefined ? (
        <div className="coin">
          ...
          <Helmet>
            <title>{coin?.name !== undefined ? `Coin ${coin?.name}` : "Loading..." }</title>
          </Helmet>
              ...
              <>
                ...
                <div className="oneNFT_des">
                  ...
                  <p className="coin_des-title">
                    ...
                    {coin.homePage ? (
                      <a href={coin.homePage} rel="noreferrer" target="_blank">
                        {coin.homePage}
                      </a>
                    ) : null}
                    {coin.github
                      ...
                      : null}
                    {coin.github ? (
                      <a href={coin.github} rel="noreferrer" target={"_blank"}>
                        {coin.github}
                      </a>
                    ) : null}
                    ...
                    {coin.reddit ? (
                      <a href={coin.reddit} rel="noreferrer" target={"_blank"}>
                        {coin.reddit}
                      </a>
                    ) : null}
                    {`${
